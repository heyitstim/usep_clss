@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('University of Southeastern Philippines')])

@section('content')
<div class="container" style="height: auto;">
  <div class="row align-items-center">
    <div class="col-md-9 ml-auto mr-auto mb-3 text-center">
      <h3>{{ __('University of Southeastern Philippines') }} </h3>
    </div>
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="{{ route('login') }}">
        @csrf
        <div class="card card-login card-hidden mb-3" style="background-color: rgba(255, 255, 255, 0.7);">
            <div class="card-header-icon text-center">
                <img src="{{ asset('storage/logo/logo.png') }}" alt="logo" title="useplogo">
            </div>
          <div class="card-body">
