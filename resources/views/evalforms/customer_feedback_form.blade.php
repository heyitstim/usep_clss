                ...
                <form method="post" action="{{ route('store_faculty_evaluation_form') }}" autocomplete="on" class="form-horizontal">
                    ...
                    <div class="card">
                        <div class="card-header-danger card-header-primary">
                            <h4 class="card-title">{{ __('Customer Feedback Form') }}</h4>
                        ...
                        <div class="card-body ">
                                    ...
                                    <div class="col">
                                        <div class="form-group label-floating has-success mb-2">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="inputGroup-sizing-sm">Transaction/Purpose</span>
                                            </div>
                            ...
                            @if($questions->id==$i)
                                ...
                                @endfor
                                <div class="container">
                                    <textarea class="form-control" placeholder="Comments/Suggestion/Complaint We have spaces for that here"></textarea>
                                </div>
