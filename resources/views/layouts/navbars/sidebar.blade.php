<div class="sidebar" data-color="rose" data-background-color="white" data-image="{{ asset('material') }}/img/eagle.jpg">
    ...
    <div class="sidebar-wrapper">
        <ul class="nav">
            ...
            <li class="nav-item {{ $activePage == 'Faculty Evaluation' ? ' active' : '' }}">
                <a class="nav-link" href="{{ route('faculty_list')}}">
                    <i class="material-icons">notes</i>
                    <p>{{ __('Faculty Evaluation') }}</p>
                </a>
            </li>
            <li class="nav-item {{ $activePage == 'College Evaluation' ? ' active' : 'Finance' }}">
                <a class="nav-link" href="{{ route('home') }}">
                    <i class="material-icons">home</i>
                    <p>{{ __('College Evaluation') }}</p>
                </a>
            </li>
